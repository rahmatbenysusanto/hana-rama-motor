                ...
                <ul class="main-menu">
                        ...
                        <ul class="slide-menu child1">
                            <li class="slide {{ $title == "dashboard utama" ? "active" : "" }}">
                                <a href="{{ route('dashboard') }}"
                                   class="side-menu__item {{ $title == "dashboard utama" ? "active" : "" }}">Dashboard
                                    Utama</a>
                            </li>
                            <li class="slide {{ $title == "dashboard oli" ? "active" : "" }}">
                                <a href="{{ route('dashboard_oli') }}"
                                   class="side-menu__item {{ $title == "dashboard oli" ? "active" : "" }}">Dashboard
                                    Oli</a>
                            </li>
                            @if(Session::get('pengaturanBarang') !== null && Session::get('pengaturanBarang') == 1)
                                <li class="slide {{ $title == "dashboard ban" ? "active" : "" }}">
                                    <a href="{{ route('dashboard_ban') }}"
                                       class="side-menu__item {{ $title == "dashboard ban" ? "active" : "" }}">Dashboard
                                        Ban</a>
                                </li>
                            @endif
                            <li class="slide {{ $title == "dashboard sparepart" ? "active" : "" }}">
                                <a href="{{ route('dashboard_sparepart') }}"
                                   class="side-menu__item {{ $title == "dashboard sparepart" ? "active" : "" }}">Dashboard
                                    Sparepart</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="slide">
                        <a href="{{ route('sparepart') }}"
                           class="side-menu__item {{ $title == "sparepart" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide">
                        <a href="{{ route('barang_rusak') }}"
                           class="side-menu__item {{ $title == "barang rusak" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide">
                        <a href="{{ route('tambah_barang_baru') }}"
                           class="side-menu__item {{ $title == "tambah barang baru" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide">
                        <a href="{{ route('tambah_pembelian_barang') }}"
                           class="side-menu__item {{ $title == "tambah stok barang" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide">
                        <a href="{{ route('daftar_pembelian') }}"
                           class="side-menu__item {{ $title == "daftar pembelian" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide">
                        <a href="{{ route('return_pembelian') }}"
                           class="side-menu__item {{ $title == "return pembelian" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide">
                        <a href="{{ route('list_return_pembelian') }}"
                           class="side-menu__item {{ $title == "list return pembelian" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide">
                        <a href="{{ route('buat_transaksi') }}"
                           class="side-menu__item {{ $title == "buat transaksi" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide">
                        <a href="{{ route('daftar_transaksi') }}"
                           class="side-menu__item {{ $title == "daftar transaksi" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide">
                        <a href="{{ route('return_transaksi') }}"
                           class="side-menu__item {{ $title == "return transaksi" ? "active" : "" }}">
                            <div style="width: 20px;">
                                <i class="fa-solid fa-arrow-rotate-left fa-lg"></i>
                            </div>
                    ...
                    <li class="slide">
                        <a href="{{ route('buat_sampel_sales') }}"
                           class="side-menu__item {{ $title == "buat sampel" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide">
                        <a href="{{ route('list_sampel') }}"
                           class="side-menu__item {{ $title == "list sampel" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide">
                        <a href="{{ route('return_sampel') }}"
                           class="side-menu__item {{ $title == "return sampel" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide has-sub {{ $title == "ambil barang" ? "open" : "" }} {{ $title == "sisa barang" ? "open" : "" }} {{ $title == "buat transaksi alif" ? "open" : "" }}">
                        ...
                        <ul class="slide-menu child1">
                            <li class="slide {{ $title == "ambil barang" ? "active" : "" }}">
                                <a href="{{ route('pengambilan_barang') }}"
                                   class="side-menu__item {{ $title == "ambil barang" ? "active" : "" }}">Ambil
                                    Barang</a>
                            </li>
                            <li class="slide {{ $title == "sisa barang" ? "active" : "" }}">
                                <a href="{{ route('sisa_barang') }}"
                                   class="side-menu__item {{ $title == "sisa barang" ? "active" : "" }}">Daftar
                                    Pengambilan</a>
                            </li>
                            <li class="slide {{ $title == "buat transaksi alif" ? "active" : "" }}">
                                <a href="{{ route('transaksi_khusus_alif') }}"
                                   class="side-menu__item {{ $title == "buat transaksi alif" ? "active" : "" }}">Transaksi
                                    Khusus Alif</a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="slide-menu child1">
                            <li class="slide {{ $title == "laporan transaksi" ? "active" : "" }}">
                                <a href="{{ route('laporan_transaksi') }}"
                                   class="side-menu__item {{ $title == "laporan transaksi" ? "active" : "" }}">Laporan
                                    Transaksi</a>
                            </li>
                            <li class="slide {{ $title == "laporan oli" ? "active" : "" }}">
                                <a href="{{ route('laporanOli') }}"
                                   class="side-menu__item {{ $title == "laporan oli" ? "active" : "" }}">Laporan Oli</a>
                            </li>
                            @if(Session::get('pengaturanBarang') !== null && Session::get('pengaturanBarang') == 1)
                                <li class="slide {{ $title == "laporan ban" ? "active" : "" }}">
                                    <a href="{{ route('laporanBan') }}"
                                       class="side-menu__item {{ $title == "laporan ban" ? "active" : "" }}">Laporan
                                        Ban</a>
                                </li>
                            @endif
                            <li class="slide {{ $title == "laporan sparepart" ? "active" : "" }}">
                                <a href="{{ route('laporanSparepart') }}"
                                   class="side-menu__item {{ $title == "laporan sparepart" ? "active" : "" }}">Laporan
                                    Sparepart</a>
                            </li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a href="{{ route('laporan_gaji') }}"
                           class="side-menu__item {{ $title == "gaji" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide">
                        <a href="{{ route('pelanggan') }}"
                           class="side-menu__item {{ $title == "pelanggan" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide">
                        <a href="{{ route('supplier') }}"
                           class="side-menu__item {{ $title == "supplier" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide">
                        <a href="{{ route('biaya_lainnya') }}"
                           class="side-menu__item {{ $title == "biaya lainnya" ? "active" : "" }}">
                            <div style="width: 20px;">
                    ...
                    <li class="slide">
                        <a href="{{ route('pengaturan') }}"
                           class="side-menu__item {{ $title == "pengaturan" ? "active" : "" }}">
                            <div style="width: 20px;">

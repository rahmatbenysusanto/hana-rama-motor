...
@section('konten')
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <h1 class="page-title fw-semibold fs-18 mb-0">Laporan Transaksi Ban</h1>
    </div>
    ...
    <div class="modal fade" id="ubahTanggal" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('laporanBanTanggal') }}" method="GET">
                    <div class="modal-body">
                        <input type="hidden" value="2" name="kategori_id">
                        <div class="mb-3">

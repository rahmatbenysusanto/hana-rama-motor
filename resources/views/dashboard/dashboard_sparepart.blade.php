...
@section('konten')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <h1 class="page-title fw-semibold fs-18 mb-0">Dashboard Sparepart</h1>
        <div class="ms-md-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboards</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Dashboard Sparepart</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <script>
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                let hahaha = new ApexCharts(document.querySelector("#chartSparepart"), dataPenjualan);
                hahaha.render();
            }
        });
    </script>

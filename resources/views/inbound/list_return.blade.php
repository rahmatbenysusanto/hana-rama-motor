...
@section('konten')
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <h1 class="page-title fw-semibold fs-18 mb-0">Daftar List Return Pembelian</h1>
    </div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="/detail-return-pembelian/{{ $in->id }}">Lihat Detail</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>

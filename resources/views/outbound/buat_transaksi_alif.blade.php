                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" placeholder="Harga Barang" name="harga" id="harga" aria-describedby="basic-addon1" required>
                        </div>
                    </div>
                    <div class="mb-3">
            ...
            if (check === 0) {
                $.ajax({
                    ...
                    success: function (params) {
                        let dataBarang = JSON.parse(localStorage.getItem('barangTransaksiAlif')) ?? [];
                        let hargaBarang = parseInt(qty) * parseInt(harga);
                        let hargaDiskon = hargaBarang * (diskon / 100);
                        ...
                        dataBarang.push({
                            ...
                            'total'         : hargaBarang - hargaDiskon,
                        });

                        localStorage.setItem('barangTransaksiAlif', JSON.stringify(dataBarang));
                        viewListBarang();
            ...
            barang.forEach(function (params) {
                html += `
                    <tr>
                        ...
                        <td>${rupiah(params.totalDiskon)}</td>
